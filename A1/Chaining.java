...
public class Chaining {
	...
	public int chain (int key) {
		...
		return ((A * key) % power2(w)) / power2(w - r);
	}
	...
	public int insertKey(int key){
		//TODO: implement this and change the return statement
		//get the chaining key
		int insert_Value = chain(key);
		ArrayList<Integer> key_table = Table.get(insert_Value);

		int collosion_number = key_table.size();

		//insert the key into table
		key_table.add(0,insert_Value);
		return collosion_number;
